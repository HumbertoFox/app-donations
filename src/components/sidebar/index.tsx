...
const menuItems = [
    { title: 'Cadastrar Doação', icon: 'fa-solid fa-pen-to-square', route: '/registerdonation' },
    { title: 'Cadastrar Doador', icon: 'fa-solid fa-user-plus', route: '/registerdonor' },
    { title: 'Editar Doação', icon: 'fa-regular fa-pen-to-square', route: '/editdonation' },
    { title: 'Editar Doador', icon: 'fa-solid fa-user-pen', route: '/editdonor' },
